              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {/* ICS DOWNLOAD BUTTON */}
                    <a 
                      href={`/api/download-schedule?name=${encodeURIComponent(employeeName)}`}
                      download
                      className="flex items-center gap-2 px-4 py-2 bg-dreamtea-blue text-white rounded-lg text-xs font-semibold hover:bg-dreamtea-blue-hover transition-colors"
                    >
