...
export function AvailabilityFullView({ staffData, validDates, periodAvailability, onRefresh, isRefreshing }: AvailabilityFullViewProps) {
  ...
  return (
    <div className="relative w-full h-[calc(100vh-180px)]">
      {isRefreshing && (
        <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 bg-white/90 shadow-md rounded-full p-2 border border-sky-100 backdrop-blur-sm">
          <svg className="w-5 h-5 text-sky-500 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          </svg>
        </div>
      )}
      <div className="w-full bg-white relative overflow-auto border border-gray-200 shadow-[0_4px_24px_rgba(0,0,0,0.05)] rounded-xl h-full">
